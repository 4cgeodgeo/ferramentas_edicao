...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{7cac1b0e-e80f-4de1-9ca3-4451cbed0d2a}">
      <rule key="{763f48d8-ba6f-4597-92e5-c643cb4e76b9}" description="Nome local">
        <settings calloutType="simple">
          <text-style useSubstitutions="0" blendMode="0" fontStrikeout="0" fontFamily="Noto Sans" capitalization="1" fieldName="texto_edicao" multilineHeight="0.80000000000000004" allowHtml="0" textColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontKerning="1" legendString="Aa" fontSize="6" fontWeight="25" fontSizeUnit="Point" isExpression="0" textOpacity="1" textOrientation="horizontal" namedStyle="Condensed Light" fontUnderline="0" fontItalic="0" fontWordSpacing="0" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255">
            <families/>
            <text-buffer bufferColor="0,0,0,255" bufferNoFill="1" bufferDraw="1" bufferSizeUnits="Point" bufferJoinStyle="128" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferSize="0.5"/>
            <text-mask maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskType="0" maskedSymbolLayers="" maskEnabled="1" maskSizeUnits="MM" maskSize="0.20000000000000001"/>
          ...
          <text-format reverseDirectionSymbol="0" autoWrapLength="0" rightDirectionSymbol=">" plussign="0" leftDirectionSymbol="&lt;" decimals="3" useMaxLineLengthForAutoWrap="1" wrapChar="|" placeDirectionSymbol="0" addDirectionSymbol="0" formatNumbers="0" multilineAlign="3"/>
          <placement preserveRotation="1" priority="5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" overrunDistanceUnit="MM" offsetType="0" centroidInside="0" dist="0" layerType="PointGeometry" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" distUnits="MM" quadOffset="4" repeatDistance="0" xOffset="0" rotationAngle="0" geometryGeneratorEnabled="1" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" placement="0" overrunDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" lineAnchorType="0" placementFlags="10" yOffset="0" offsetUnits="MM" centroidWhole="0" fitInPolygonOnly="0"/>
          <rendering fontLimitPixelSize="0" labelPerPart="0" minFeatureSize="0" scaleVisibility="0" mergeLines="0" obstacleType="1" unplacedVisibility="0" scaleMin="0" scaleMax="0" upsidedownLabels="0" displayAll="0" obstacle="1" drawLabels="1" fontMinPixelSize="3" fontMaxPixelSize="10000" zIndex="0" limitNumLabels="0" obstacleFactor="1" maxNumLabels="2000"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
