...
<qgis version="3.22.1-Białowieża" labelsEnabled="1" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{2384a401-8dc6-4663-9cd5-fc0e21310943}">
      <rule description="Cota texto de edição" key="{8e14a1b5-a305-4216-b6da-fc25d740ad3f}" filter="&quot;indice&quot; = 1">
      ...
      <rule description="Simb cota mestra" key="{7ef10a9c-acbf-4ed6-94cc-f7f19851c969}" filter="&quot;indice&quot; = 1 AND &quot;texto_edicao&quot; IS NULL AND array_contains(array_foreach(@map_layers,   layer_property( @element , 'name'))  , 'edicao_simb_cota_mestra_l')">
        <settings calloutType="simple">
